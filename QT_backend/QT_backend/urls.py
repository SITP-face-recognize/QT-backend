...
from course.views import CourseViewset, SignViewset,TeacherCourseViewset,SignCourseViewset
...
router.register(r'signCourse', SignCourseViewset, base_name="signCourse")
